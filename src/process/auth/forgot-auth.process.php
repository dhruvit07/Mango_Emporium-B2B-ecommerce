...
if (isset($_POST['password-reset-token']) && $_POST['email']) {
    ...
    if ($row) {
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                            ...
                                            <tr>
                                                ...
                                                <a href="' . $link . '" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: "Source Sans Pro", Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Click Here</a>
                                                </td>
                                            </tr>
                                            </table>
                                        </td>
        ...
        if ($mail->send()) {
            ...
            header("location: ../../../public/auth/forgot.php?msg");
        } else {
            $_SESSION['msg'] = "Error while Mail Sending!";
            header("location: ../../../public/auth/forgot?msg");
        }
    } else {
        $_SESSION['msg'] = "Mail doesn't Exist";
        header("location: ../../../public/auth/forgot?msg");
    }
} else if (isset($_POST['password']) && $_POST['reset_link_token']) {
    ...
    $obj = new auth();
    $result = $obj->fetchToken(trim($token), trim($email));
